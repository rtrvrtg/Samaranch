...
Tabulous.setup do |config|
  ...
  config.actions do
    [
      ...
      [    :session_types           ,    :all_actions    ,    :session_types_tab           ],
      [    :locations               ,    :all_actions    ,    :locations_tab               ],
      [    :markers                 ,    :all_actions    ,    :markers_tab                 ],
      [    :venue_maps              ,    :all_actions    ,    :venue_maps_tab              ],
      [    :venue_travel_details    ,    :all_actions    ,    :venue_travel_details_tab    ],
      [    :venues                  ,    :all_actions    ,    :venues_tab                  ],
      [    :admin                   ,    :all_actions    ,    :admin_tab                   ],
      [    :admin                   ,    :all_actions    ,    :admin_tab                   ],
      #------------------------------------------------------------------------------------#
      #    CONTROLLER               |    ACTION          |    TAB                          #
      #------------------------------------------------------------------------------------#
